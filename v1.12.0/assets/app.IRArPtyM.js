import{T as p}from"./chunks/theme.DGYVaskk.js";import{R as s,an as i,ao as u,ap as c,aq as l,ar as f,as as d,at as m,au as h,av as g,aw as A,d as v,u as y,v as w,s as C,ax as P,ay as R,az as T,am as b}from"./chunks/framework.B3yFwKAD.js";function r(e){if(e.extends){const a=r(e.extends);return{...a,...e,async enhanceApp(t){a.enhanceApp&&await a.enhanceApp(t),e.enhanceApp&&await e.enhanceApp(t)}}}return e}if (typeof window !== "undefined") {
  const siteData = window.__VP_SITE_DATA__ || null;
  const pathname = window.location && typeof window.location.pathname === 'string' ? window.location.pathname : null;
  if (siteData && typeof siteData.base === 'string' && pathname) {
